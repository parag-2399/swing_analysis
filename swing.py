...
sectors={
    'NIFTY_AUTO':['BHARATFORG','EICHERMOT','ESCORTS','SONACOMS','ASHOKLEY','MRF','BALKRISIND','BAJAJ-AUTO','TATAMOTORS','M&M','TIINDIA','TVSMOTOR','BOSCHLTD','HEROMOTOCO','MARUTI','AMARAJABAT','APPOLOTYRE','CEAT','ENDURANCE','EXIDEIND','JKTYRE','MINDAIND','SUNDRMFAST','SUPRAJIT','VARROC','WABCOINDIA'],
    ...
    'NIFTY_EV':['AMARAJABAT','MOTHERSUMI','SUNDRMFAST','ENDURANCE','SONACOMS','GREAVESCOT','HEROMOTOCO','IOC','KPITTECH','M&M','POWERGRID','TATAPOWER','TATAELXSI','OLECTRA','TATAMOTORS']
